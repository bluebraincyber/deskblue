    ...
    <div className="w-full">
      <section className="text-center py-12 sm:py-20 px-4">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a href="#" className="w-full sm:w-auto bg-green-500 text-white px-6 sm:px-8 py-3 rounded-full font-semibold hover:bg-green-600 transition-colors text-center flex items-center justify-center gap-2">
